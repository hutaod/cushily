import type { NextraThemeLayoutProps, PageOpts } from '@cushily/nextra'
...
import cn from 'clsx'
import { MDXProvider } from '@cushily/nextra/mdx'
...
export { useMDXComponents } from '@cushily/nextra/mdx'
