...
- e6771ca: BREAKING! various theme config options was renamed, take a look of renamed options [here](https://github.com/hutaod/cushily/blob/core/packages/nextra-theme-docs/src/constants.tsx)
...
- da998e6: move react components to `components` folder and replace exports:
  ```ts
  import Callout from '@cushily/nextra-theme-docs/callout'
  import Collapse from '@cushily/nextra-theme-docs/collapse'
  import Bleed from '@cushily/nextra-theme-docs/bleed'
  import { Tabs, Tab } from '@cushily/nextra-theme-docs/tabs'
  ```
  by
  ```ts
  import { Callout, Collapse, Bleed, Tabs, Tab } from '@cushily/nextra-theme-docs'
  ```
...
- 06aa62f: feat: allow `import { getComponents } from '@cushily/nextra-theme-docs'`
