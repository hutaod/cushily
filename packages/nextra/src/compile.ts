...
export async function compileMdx(
  ...
  // https://github.com/hutaod/cushily/issues/1303
  ...
  const compiler =
    ...
    (cachedCompilerForFormat[format] = createProcessor({
      ...
      providerImportSource: isFileOutsideCWD
        ? require.resolve('@cushily/nextra').replace(/index\.js$/, 'mdx.mjs') // fixes Package subpath './mdx' is not defined by "exports"
        : '@cushily/nextra/mdx',
      remarkPlugins: [
        ...(remarkPlugins || []),
  ...
  try {
    ...
    return {
      // https://github.com/hutaod/cushily/issues/1032
